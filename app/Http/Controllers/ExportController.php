...
class ExportController extends Controller
{
    public function index()
    {
        ...
        // $order = Chapter::orderBy('order', 'asc')->get();
        ...
        $zip->addFile(public_path('css/offline/public.css'), 'resources/offlinepublic.css');
        $zip->addFile(public_path('css/offline/skin.css'), 'resources/offlineskin.css');
        $zip->addFile(public_path('css/offline/demo.css'), 'resources/offlinedemo.css');
        $zip->addFile(public_path('css/offline/content.css'), 'resources/offlinecontent.css');
        $zip->addFile(public_path('js/ckeditor/ckeditor999.js'), 'resources/ckeditor.js');
        $zip->addFile(public_path('js/menu.js'), 'resources/menu.js');
        $zip->addFile(public_path('js/editor/json-to-html.js'), 'resources/json-to-html.js');
        $zip->close();
