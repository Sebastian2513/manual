...
<body class="@if ($darkTheme) dark-theme-variables @endif">
    <div class="base-cont" id="baseCont">
        ...
        <div class="top">
                <div class="logo">
                    <a href="/">
                        <img src="{{ asset('images/logo.png') }}" alt="wilke logo" id="icon">
                    </a>
                </div>
                <div class="logo">
                    <a href="/">
        ...
        <div class="base-right">
            <div class="top sticky-header">
                ...
                <div class="profile" onclick="window.location.href='{{ route ('profile')}}'">
                    <div class="info">
                        <p><span  class="infoR">Hey,</span> <b>Admin</b></p>
                        <small class="text-muted-dark">Wilke Manuals</small>
                    </div>
