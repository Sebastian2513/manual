...
@section('script')
    ...
    <script>
        ...
        ClassicEditor.create(document.getElementById("ckeditor"), CKEditorConfig).then(newEditor => {
...
<body>
    ...
    <div class="editor5">
            ...
            {{-- <link rel="stylesheet" href="resources/css/ckeditor/content.css"> --}}
                <textarea id="ckeditor" name="content" class="" style="display:none"></textarea>
    </div>
    </sub>
</body>
@endsection
