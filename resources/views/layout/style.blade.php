    ...
    <div class="styles">
        ...
        <div class="container">
            ...
            <div class="notification">
                <p class="pstyle">note that these settings will only apply on the public page and the exported htmls, the editor is
                    excluded.
                </p>
                <p class="pstyle">attributes below are the general attributes and are mostly for the non-content parts of the manual. </p>
            </div>
            ...
            <div class="notification">
                <p class="pstyle">attributes below are general size and colors and are only for the content part of the page.</p>
            </div>
            <div class="body-style">
                <div class="item">
                    <h4>Css key name</h4>
            ...
            <div class="notification">
                <p class="pstyle">attrubutes below are specificly for the checklist element.</p>
            </div>
            <div class="body-style">
                <div class="item">
                    <h4>Css key name</h4>
            ...
            <div class="notification">
                <p class="pstyle">attributes below are specificly for the code block element.</p>
            </div>
            <div class="body-style">
                <div class="item">
                    <h4>Css key name</h4>
            ...
            <div class="notification">
                <p class="pstyle">attributes below are specificly for the warning block element.</p>
            </div>
            <div class="body-style">
                <div class="item">
                    <h4>Css key name</h4>
	    ...
	    <div class="notification">
                <p class="pstyle">attributes below are specificly for the tip block element.</p>
            </div>
            <div class="body-style">
                <div class="item">
                    <h4>Css key name</h4>
            ...
            <div class="notification">
                <p class="pstyle">attributes below are specificly for the table block element.</p>
            </div>
            <div class="body-style">
                <div class="item">
                    <h4>Css key name</h4>
