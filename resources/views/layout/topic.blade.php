                    ...
                    @foreach ($topics as $topic)
                        <tr>
                            {{-- <td style="max-width: 20px; text-align: center;">
                                <input type="text" class="order-input" data-topicId="{{$topic->id}}" readonly value="{{ $topic->id }}"style="max-width: 70%; background: none">
                            </td> --}}
                            <td style="max-width: 20px; text-align-last: center;">
                                <input type="text" class="order-input" data-topicId="{{$topic->id}}" readonly value="{{ $topic->order }}" style="max-width: 70%; background: none">
                            </td>
                            <td style="text-align-last: center; max-width: 30px">
